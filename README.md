...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,336 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,719 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,129 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-15 - Official Tailwind CSS plugin for Prettier.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-24 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 🔼 [RustyWind](https://github.com/avencera/rustywind) ⭐ 622 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - CLI tool for sorting Tailwind CSS classes.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,197 | 🐛 33 | 🌐 JavaScript | 📅 2026-08-24 - UI Components for Tailwind CSS.
