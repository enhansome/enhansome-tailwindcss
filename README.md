...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,527 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,743 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* [Editor support for VS2022](https://github.com/theron-wang/VS2022-Editor-Support-for-Tailwind-CSS) ⭐ 149 | 🐛 0 | 🌐 C# | 📅 2026-09-11 - IntelliSense, linting, sorting, and more in Visual Studio 2022.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,131 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-01 - Official Tailwind CSS plugin for Prettier.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-11 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
* 💼 [tailwindcss-rails](https://github.com/rails/tailwindcss-rails) ⭐ 1,586 | 🐛 6 | 🌐 Ruby | 📅 2026-09-10 - Gem for using Tailwind CSS with Rails' asset pipeline.
* 🔼 [RustyWind](https://github.com/avencera/rustywind) ⭐ 623 | 🐛 6 | 🌐 Rust | 📅 2026-08-26 - CLI tool for sorting Tailwind CSS classes.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,363 | 🐛 46 | 🌐 JavaScript | 📅 2026-09-12 - UI Components for Tailwind CSS.
* 📁 [Flowbite Admin Dashboard](https://github.com/themesberg/flowbite-admin-dashboard) ⭐ 2,883 | 🐛 16 | 🌐 HTML | 📅 2025-03-20 - Open-source admin dashboard template built with Tailwind CSS and Flowbite.
...
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,720 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Tailwind CSS Astro starter template.
...
* 📁 [Astro Template Dante](https://github.com/JustGoodUI/dante-astro-theme) ⭐ 512 | 🐛 8 | 🌐 Astro | 📅 2026-07-21 - Tailwind CSS & Astro blog/portfolio template.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,466 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
* 💙 [Forms](https://github.com/tailwindlabs/tailwindcss-forms) ⭐ 4,565 | 🐛 4 | 🌐 HTML | 📅 2026-05-12 - Adds better default styles to form elements.
* 💼🧩 [Fluid](https://github.com/barvian/fluid-tailwind) ⭐ 1,779 | 🐛 7 | 🌐 TypeScript | 📅 2025-03-17 - Adds fluid `clamp()` versions of every built-in utility.
...
* 🎨 [Themer](https://github.com/RyanClementsHax/tailwindcss-themer) ⭐ 315 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-09 - Adds theming support for Tailwind CSS with CSS variables and variants.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-10 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,719 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12.
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 103 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
