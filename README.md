...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,414 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-31 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,729 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,130 | 🐛 17 | 🌐 TypeScript | 📅 2026-07-15 - Official Tailwind CSS plugin for Prettier.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,256 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-31 - UI Components for Tailwind CSS.
...
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,726 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Tailwind CSS Astro starter template.
...
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 95 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-31 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
