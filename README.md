...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,303 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,718 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-22 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,175 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-23 - UI Components for Tailwind CSS.
...
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,717 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Tailwind CSS Astro starter template.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,451 | 🐛 10 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
