...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,482 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,742 | 🐛 110 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,135 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-01 - Official Tailwind CSS plugin for Prettier.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-09 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
* 💼 [tailwindcss-rails](https://github.com/rails/tailwindcss-rails) ⭐ 1,586 | 🐛 7 | 🌐 Ruby | 📅 2026-09-08 - Gem for using Tailwind CSS with Rails' asset pipeline.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,344 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-08 - UI Components for Tailwind CSS.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,464 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 💼🧩 [Fluid](https://github.com/barvian/fluid-tailwind) ⭐ 1,781 | 🐛 7 | 🌐 TypeScript | 📅 2025-03-17 - Adds fluid `clamp()` versions of every built-in utility.
...
* 🎨 [Themer](https://github.com/RyanClementsHax/tailwindcss-themer) ⭐ 314 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-09 - Adds theming support for Tailwind CSS with CSS variables and variants.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-09 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,717 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12.
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 99 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
