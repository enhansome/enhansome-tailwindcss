...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,437 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-02 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,731 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,132 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-01 - Official Tailwind CSS plugin for Prettier.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-03 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
* 💼 [tailwindcss-rails](https://github.com/rails/tailwindcss-rails) ⭐ 1,587 | 🐛 6 | 🌐 Ruby | 📅 2026-08-16 - Gem for using Tailwind CSS with Rails' asset pipeline.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,283 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-03 - UI Components for Tailwind CSS.
* 📁 [Flowbite Admin Dashboard](https://github.com/themesberg/flowbite-admin-dashboard) ⭐ 2,878 | 🐛 16 | 🌐 HTML | 📅 2025-03-20 - Open-source admin dashboard template built with Tailwind CSS and Flowbite.
...
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,724 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Tailwind CSS Astro starter template.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,458 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 🎨 [Themer](https://github.com/RyanClementsHax/tailwindcss-themer) ⭐ 314 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-03 - Adds theming support for Tailwind CSS with CSS variables and variants.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-03 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,717 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12.
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 98 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-31 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
