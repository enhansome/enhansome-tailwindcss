...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,506 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,744 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* [Editor support for VS2022](https://github.com/theron-wang/VS2022-Editor-Support-for-Tailwind-CSS) ⭐ 149 | 🐛 1 | 🌐 C# | 📅 2026-09-11 - IntelliSense, linting, sorting, and more in Visual Studio 2022.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,132 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-01 - Official Tailwind CSS plugin for Prettier.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,361 | 🐛 46 | 🌐 JavaScript | 📅 2026-09-11 - UI Components for Tailwind CSS.
* 📁 [Flowbite Admin Dashboard](https://github.com/themesberg/flowbite-admin-dashboard) ⭐ 2,881 | 🐛 16 | 🌐 HTML | 📅 2025-03-20 - Open-source admin dashboard template built with Tailwind CSS and Flowbite.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-10 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,718 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12.
