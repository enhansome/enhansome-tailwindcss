...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,568 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,740 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-15 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,390 | 🐛 49 | 🌐 JavaScript | 📅 2026-09-14 - UI Components for Tailwind CSS.
...
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,721 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Tailwind CSS Astro starter template.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-15 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,718 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-15.
