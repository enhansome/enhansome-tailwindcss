...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,398 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-14 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,728 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,131 | 🐛 17 | 🌐 TypeScript | 📅 2026-07-15 - Official Tailwind CSS plugin for Prettier.
* 💼 [Config viewer](https://github.com/rogden/tailwind-config-viewer) ⭐ 2,214 | 🐛 43 | 🌐 Vue | 📅 2024-11-22 - Local UI tool for visualizing your Tailwind CSS configuration file.
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,867 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-30 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
* 💼 [tailwindcss-rails](https://github.com/rails/tailwindcss-rails) ⭐ 1,586 | 🐛 6 | 🌐 Ruby | 📅 2026-08-16 - Gem for using Tailwind CSS with Rails' asset pipeline.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,250 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-24 - UI Components for Tailwind CSS.
* 📁 [Flowbite Admin Dashboard](https://github.com/themesberg/flowbite-admin-dashboard) ⭐ 2,877 | 🐛 16 | 🌐 HTML | 📅 2025-03-20 - Open-source admin dashboard template built with Tailwind CSS and Flowbite.
* 📁 [Admin One Vue 3](https://github.com/justboil/admin-one-vue-tailwind) ⭐ 2,465 | 🐛 34 | 🌐 Vue | 📅 2025-11-27 - Free Vue.js 3 Tailwind CSS admin template with Vite & Vue CLI support.
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,725 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Tailwind CSS Astro starter template.
...
* 📁 [Astro Template Dante](https://github.com/JustGoodUI/dante-astro-theme) ⭐ 511 | 🐛 8 | 🌐 Astro | 📅 2026-07-21 - Tailwind CSS & Astro blog/portfolio template.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,456 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-28 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,717 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12.
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 92 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-31 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
...
* 💼 [px to viewport](https://github.com/the-lemonboy/tailwindcss-px-to-viewport) ⭐ 10 | 🐛 0 | 🌐 CSS | 📅 2025-07-27 - Adds utilities to automatically convert px to vw / vh.
* 💼 [tailwind-hitslop](https://github.com/Jubstaaa/tailwind-hitslop) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-28 - Adds `hit-slop` utilities to invisibly expand touch targets, like React Native's `hitSlop`.
