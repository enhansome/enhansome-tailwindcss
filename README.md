...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,495 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,741 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-10 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,354 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-10 - UI Components for Tailwind CSS.
...
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 100 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
