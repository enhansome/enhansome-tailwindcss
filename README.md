...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,583 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
...
* 💼 [Config viewer](https://github.com/rogden/tailwind-config-viewer) ⭐ 2,215 | 🐛 43 | 🌐 Vue | 📅 2024-11-22 - Local UI tool for visualizing your Tailwind CSS configuration file.
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-16 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
* 💼 [tailwindcss-rails](https://github.com/rails/tailwindcss-rails) ⭐ 1,587 | 🐛 6 | 🌐 Ruby | 📅 2026-09-10 - Gem for using Tailwind CSS with Rails' asset pipeline.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,394 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-14 - UI Components for Tailwind CSS.
...
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,723 | 🐛 9 | 🌐 Astro | 📅 2026-09-16 - Tailwind CSS Astro starter template.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,469 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 💼🧩 [Fluid](https://github.com/barvian/fluid-tailwind) ⭐ 1,778 | 🐛 7 | 🌐 TypeScript | 📅 2025-03-17 - Adds fluid `clamp()` versions of every built-in utility.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-16 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,720 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-15.
