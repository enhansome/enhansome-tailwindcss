...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,481 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-08 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,332 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-08 - UI Components for Tailwind CSS.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,463 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 98 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
