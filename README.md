...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,546 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,868 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-13 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,367 | 🐛 49 | 🌐 JavaScript | 📅 2026-09-12 - UI Components for Tailwind CSS.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,467 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 💼 [tw-fade](https://github.com/petekp/tw-fade) ⭐ 103 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-13 - Adds `fade-t`/`-b`/`-x`/`-y` utilities that enable scroll-aware edge fading.
...
* 💼 [px to viewport](https://github.com/the-lemonboy/tailwindcss-px-to-viewport) ⭐ 12 | 🐛 0 | 🌐 CSS | 📅 2025-07-27 - Adds utilities to automatically convert px to vw / vh.
