...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,287 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-14 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,716 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,127 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-15 - Official Tailwind CSS plugin for Prettier.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,867 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-22 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 🔼 [RustyWind](https://github.com/avencera/rustywind) ⭐ 622 | 🐛 8 | 🌐 Rust | 📅 2026-08-20 - CLI tool for sorting Tailwind CSS classes.
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,169 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-22 - UI Components for Tailwind CSS.
...
* 📁 [Astro Template Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,716 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Tailwind CSS Astro starter template.
...
* 📁 [Astro Template Dante](https://github.com/JustGoodUI/dante-astro-theme) ⭐ 508 | 🐛 8 | 🌐 Astro | 📅 2026-07-21 - Tailwind CSS & Astro blog/portfolio template.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,451 | 🐛 9 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 🎨 [Themer](https://github.com/RyanClementsHax/tailwindcss-themer) ⭐ 314 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-22 - Adds theming support for Tailwind CSS with CSS variables and variants.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-18 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,716 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12.
