...
* 💙 [Repository](https://github.com/tailwindcss/tailwindcss) ⭐ 97,558 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-08 - Official Tailwind CSS repository.
* 💙 [Headless UI](https://github.com/tailwindlabs/headlessui) ⭐ 28,742 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - Completely unstyled, fully accessible UI components.
...
* [Editor support for VS2022](https://github.com/theron-wang/VS2022-Editor-Support-for-Tailwind-CSS) ⭐ 149 | 🐛 0 | 🌐 C# | 📅 2026-09-14 - IntelliSense, linting, sorting, and more in Visual Studio 2022.
...
* 💙💼 [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) ⭐ 7,130 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-01 - Official Tailwind CSS plugin for Prettier.
...
* 💼 [`@nuxtjs/tailwindcss`](https://github.com/nuxt-community/tailwindcss-module) ⭐ 1,867 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-13 - Tailwind CSS module for Nuxt.js with PurgeCSS and modern CSS (preset env 1).
...
* 📚 [Daisy UI](https://github.com/saadeghi/daisyui) ⭐ 42,379 | 🐛 46 | 🌐 JavaScript | 📅 2026-09-14 - UI Components for Tailwind CSS.
* 📁 [Flowbite Admin Dashboard](https://github.com/themesberg/flowbite-admin-dashboard) ⭐ 2,884 | 🐛 16 | 🌐 HTML | 📅 2025-03-20 - Open-source admin dashboard template built with Tailwind CSS and Flowbite.
...
* 💙🧩 [Typography](https://github.com/tailwindlabs/tailwindcss-typography) ⭐ 6,468 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-08 - Adds a `prose` class for beautiful typographic defaults.
...
* 💼 [Leading Trim](https://github.com/stormwarning/tailwindcss-capsize) ⭐ 122 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-14 - Adds utilities to trim text whitespace, using [Capsize](https://github.com/seek-oss/capsize) ⭐ 1,719 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-15.
...
* 💼 [px to viewport](https://github.com/the-lemonboy/tailwindcss-px-to-viewport) ⭐ 21 | 🐛 0 | 🌐 CSS | 📅 2025-07-27 - Adds utilities to automatically convert px to vw / vh.
